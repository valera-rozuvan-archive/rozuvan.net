...
class SimpleRbacAssignChildPermissionForm extends CFormModel
{
	...
	public $newPermissionArray = array();
	
    public function __construct($roleName)
    {
        $own = SRUser::getChildPermissions($roleName);
		$all = SRUser::getAllPermissions();
		
        foreach ($all as $child) {
			if (!in_array($child, $own))
		        $this->newPermissionArray[$child] = $child;	
		}
	}
    ...
    public function attributeLabels()
    {
        return array(
            ...
            'childPermission'  => 'Select child permission',
        );
    }
